...
%
% Usage:
% save2pdf_transparent; 
% save2pdf_transparent(figure_handle);
% save2pdf_transparent(figure_handle, filename)
% 
% Input:
% figure_handle : default is current figure.
% filename : name of pdf file. If filename is not specified, GUI appears
%
% #Dependency
...
function save2pdf_transparent(varargin)
narginchk(0,2);
if nargin < 1
    f = gcf;
else
